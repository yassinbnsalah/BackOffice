...
@Component({
  selector: 'app-modifiy-my-profile',
  templateUrl: './modifiy-my-profile.component.html',
  styleUrls: ['./modifiy-my-profile.component.css']
})
export class ModifiyMyProfileComponent {
  userEmail!: string;
  user!: User;
  myForm!: FormGroup;
